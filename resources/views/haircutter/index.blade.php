...
<section class="courses__current">
    <div class="courses__head">
        <h2 class="courses__title">Курсы Парикмахерского искусства</h2>      
    </div>
    <div class="slider__noscrollable">
      ...
      <h2 class="courses__current_title"><span>Курсы парикмахера</span> рассчитаны на 3-4 месяца обучения.
        <span>Убедитесь, что кроме доступных цен на все курсы, вы получите ряд преимуществ:</span>
      </h2>
        <ul class="education__list education__list-courses">
        <li class=" education__item-haircutter">
          <img src="images/education_icons/edu8.png" alt="" class="education__item-img haircutter_wrapper">
          <p class="education__itme-text education__item-text-haircutter"> Расходные материалы от производителя профессиональной косметики Ollin</p> 
        </li>
        <li class="education__item-haircutter">
          <img src="images/education_icons/edu5.png" alt="" class="education__item-img haircutter_wrapper">
...
<section class="seminars">
    <div class="courses__head">
        <h2 class="courses__title">Семинары Парикмахерского искусства</h2>      
    </div>
    ...
    <div class="seminars__items">
      <div class="seminars__item">
        ...
        <p class="seminars__item-text-last">Курсы обучения парикмахеров — выгодное вложение средств в образование, которое быстро дает реальный доход. Сразу после окончания курсов Вы будете трудоустроены в лучшие салоны Санкт-Петербурга. Для иногородних студентов — это отличная возможность начать карьеру в культурной столице России.
        </p>
      </div>
      <div class="seminars__item">
      ...
      <div class="seminars__item">
        <img src="images/education_icons/edu12.png" alt="" class="education__item-img">
