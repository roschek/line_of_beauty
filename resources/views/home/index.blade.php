 ...
 <main>
  <section class="preferences">
    <div class="preferences__card">
      <div class="preferences__number">
        <p class="preferences__number_item">1</p>
      </div>
  ...
  <section class="courses">
    ...
    <div class="courses__grid">
        <img src="images/courses_img1.png" alt="" class="courses__grid-image">
        ...
        <img src="images/courses_img2.png" alt="" class="courses__grid-image">
        <div class="courses__grid-text-item">
        ...
        <img src="images/courses_img3.png" alt="" class="courses__grid-image">
        <div class="courses__grid-text-item">
        ...
        <img src="images/courses_img4.png" alt="" class="courses__grid-image">
        <div class="courses__grid-text-item">
        ...
        <img src="images/courses_img5.png" alt="" class="courses__grid-image">
        <div class="courses__grid-text-item">
